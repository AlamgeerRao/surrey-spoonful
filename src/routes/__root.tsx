...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Homemade Pakistani Food, Surrey — Byfleet, West Byfleet, Woking & Weybridge" },
      {
        name: "description",
        content:
          "Authentic homemade Pakistani food cooked fresh in Surrey and delivered to Byfleet, West Byfleet, Woking and Weybridge. Halal karahi, biryani, daal & sides.",
      },
      { name: "keywords", content: "Homemade Pakistani Food, Pakistani food Surrey, Byfleet, West Byfleet, Woking, Weybridge, halal delivery, karahi, biryani" },
      { name: "author", content: "Homemade Pakistani Kitchen" },
      { property: "og:title", content: "Homemade Pakistani Food, Surrey — Byfleet, Woking, Weybridge" },
      {
        property: "og:description",
        content:
          "Halal Pakistani home food, cooked fresh in Surrey and delivered to Byfleet, West Byfleet, Woking and Weybridge.",
      },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Homemade Pakistani Kitchen" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#c2563b" },
      { name: "twitter:title", content: "Homemade Pakistani Food, Surrey" },
      { name: "twitter:description", content: "Halal Pakistani home food delivered to Byfleet, West Byfleet, Woking and Weybridge." },
